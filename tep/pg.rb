...
module Pg
  ffi_cflags "-DTEP_PG_O_UNSET"
  ffi_cflags "-DTEP_PG_CFLAGS_UNSET"
  # spin path: the tep_pg.o arrives via [native] libs; libpq itself is a
  # system lib the linker must still resolve (vendor path got it from
  # pkg-config through the CFLAGS placeholder).
  ffi_lib    "pq"
